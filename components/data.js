 ...
 export const athletes = [
    {id:1,
      name: 'Neeraj Chopra',
      Country: 'India',
      Photo: require('../assets/Images/Neeraj.jpg'),
    },
    {id:2,
      name: 'Yohan Blake',
      Country: 'Jamaika',
      Photo: require('../assets/Images/blake.jpg'),
    },
    {id:3,
      name: 'Justin Gatlin',
      Country: 'USA',
      Photo: require('../assets/Images/Gatlin.jpg'),
    },
    {id:4,
      name: 'Usain Bolt',
      Country: 'Jamaika',
      Photo: require('../assets/Images/Bolt.jpg'),
    },
    {id:5,
      name: 'Christian Colman',
      Country: 'USA',
      Photo: require('../assets/Images/Colman.jpg'),
    },
    ];

    export const dummyData = ['one ','two ','three ','four ','five ','six ','seven ','eight ','nine ','ten ','eleven ','twelve ','thirteen ',
